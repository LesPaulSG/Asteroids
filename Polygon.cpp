...
Polygon::Polygon(sf::Vector2f pos_, std::vector<sf::Vector2f> points)
	...
	for (auto& edge : edges) {
		...
		edge.SetPos(pos);// -edge.GetLine().pointB);
		//std::cout << "___" << edge.GetLine().pointA.x << ' ' << edge.GetLine().pointA.y << std::endl;
		//std::cout << "___" << edge.GetLine().pointB.x << ' ' << edge.GetLine().pointB.y << std::endl;
	}
	//Move(pos);
}
...
void Polygon::Draw(sf::RenderWindow& w) const{
	for (auto edge : edges) {
		w.draw(edge.GetBody());
		//std::cout << "_d__" << edge.GetLine().pointA.x << ' ' << edge.GetLine().pointA.y << std::endl;
		//std::cout << "_d__" << edge.GetLine().pointB.x << ' ' << edge.GetLine().pointB.y << std::endl;
	}
}
...
void Polygon::Move(sf::Vector2f dest){
	...
	for (auto& edge : edges) {
		...
		edge.Move(diff);// -edge.GetLine().pointB);
		//std::cout << "_m__" << edge.GetLine().pointA.x << ' ' << edge.GetLine().pointA.y << std::endl;
		//std::cout << "_m__" << edge.GetLine().pointB.x << ' ' << edge.GetLine().pointB.y << std::endl;
	}
...
void Polygon::Rotate(float angle){
	...
	for (auto& edge : edges) {
		...
		//edge.Move(edge.GetLine().pointB + pos);
	}
}
